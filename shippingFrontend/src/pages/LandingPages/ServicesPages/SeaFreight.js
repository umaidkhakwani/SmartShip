...
import bgImage from "../../../../src/assets/images/homeBannerImage4.jpg";
          ...
          <Grid item xs={12} lg={8} sx={{ mx: { xs: 2, sm: 0, md: 0, lg: 0 } }}>
            <MKBox mb={5}>
              ...
              <MKTypography display="block" variant="5" fontWeight="bold" mt={1} mb={2}>
                {t(`SeaFreight.section1.title`)}
              </MKTypography>
              <MKTypography display="block" variant={"body2"} color="text">
                {t(`SeaFreight.section1.description`)}
              </MKTypography>
              {/* <MKTypography display="block" variant={"body2"} color="text" mt={3}>
                We manage every aspect of your air freight needs—from direct shipments to
                consolidated loads, even hazardous materials. With our local expertise and
                international reach, we ensure your cargo moves smoothly across borders, backed by
                comprehensive tracking and efficient, reliable delivery solutions.
              </MKTypography> */}
            </MKBox>

            <MKBox mb={5}>
              <MKTypography display="block" variant="h5" fontWeight="bold" mt={1} mb={2}>
                {t(`SeaFreight.section2.title`)}
              </MKTypography>
              <MKTypography display="block" variant="body2" color="text" mt={3}>
                {t(`SeaFreight.section2.description`)}
              </MKTypography>
            </MKBox>
            <MKBox mb={5}>
              <MKTypography display="block" variant="h5" fontWeight="bold" mt={1} mb={2}>
                {t(`SeaFreight.section3.title`)}
              </MKTypography>
              <MKTypography display="block" variant="body2" color="text" mt={3}>
                {t(`SeaFreight.section3.description`)}
              </MKTypography>
            </MKBox>

            <MKBox mb={5}>
              <MKTypography display="block" variant="h5" fontWeight="bold" mt={1} mb={2}>
                {t(`SeaFreight.section4.title`)}
              </MKTypography>
              <MKTypography display="block" variant="body2" color="text" mt={3}>
                <ul>
                  {t("SeaFreight.section4.highlights", { returnObjects: true }).map(
                    (highlights, index) => (
