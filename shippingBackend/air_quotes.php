...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate form data
    if (empty($full_name) || empty($email) || empty($origin_airport) || empty($destination_airport) || empty($commodity_value)) {
        echo json_encode(['error' => 'Required fields are missing.']);
        exit();
    }

    // Prepare SQL query to insert the data
    $sql = "INSERT INTO air_quotes (
        full_name, email, phone_number, company_name, origin_airport, 
        destination_airport, commodity_value, gross_weight, length, 
        width, height, number_of_packages, package_type, 
        comments, commodity, 
        weight_unit, add_insurance, incoterms
    ) VALUES (
        :full_name, :email, :phone_number, :company_name, :origin_airport, 
        :destination_airport, :commodity_value, :gross_weight, :length, 
        :width, :height, :number_of_packages, :package_type, 
    ...
    try {
        ...
        $stmt->bindParam(':origin_airport', $origin_airport);
        $stmt->bindParam(':destination_airport', $destination_airport);
       ...
       try {
           ...
           $mail->Body = "
                ...
                <body>
                    ...
                    <p>Thank you for choosing <b>Amanullah Transport & Logistics</b> for your air freight and logistics needs. We have successfully received your <b>Air</b> quote request. Below are the details of your submission for your reference:</p>
                    ...
                    <ul>
                        <li><b>Origin Port:</b> $origin_airport</li>
                        <li><b>Destination Port:</b> $destination_airport</li>
                    ...
                    if (!empty($incoterms)) {
                        $mail->Body .= "<ul><li><b>Incoterms:</b> $incoterms</li></ul>";
                    }
            ...
            <p>A new quote request has been received for Air Transport. Please find the details of the submission below for your reference:</p>
