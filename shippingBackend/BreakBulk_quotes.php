...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO breakbulk_quotes (
                ...
                comments, commodity, weight_unit, add_insurance, unit_type, mode
            ) VALUES (
                :full_name, :email, :phone_number, :company_name, :origin_port, 
                :destination_port, :commodity_value, :gross_weight, :length, 
                :width, :height, :number_of_packages, :package_type, 
       ...
       try {
           ...
           $mail->Body = "
                ...
                <body>
                    ...
                    <p>Thank you for choosing <b>Amanullah Transport & Logistics</b> for your air freight and logistics needs. We have successfully received your <b>Break Bulk</b> Quote request. Below are the details of your submission for your reference:</p>
    ...
    $mail->send();
       ...
       try {
        ...
        $companyEmailBody = "
            ...
            <p>A new quote request has been received for Break Bulk Transport. Please find the details of the submission below for your reference:</p>
